...
namespace Xam.RMessage
{
	...
	interface RMessageView
	{
        ...
        // todo
		// @property (assign, nonatomic) NSTextAlignment titleAlignment __attribute__((annotate("ui_appearance_selector")));
        ...
        // todo
		// @property (assign, nonatomic) NSTextAlignment subtitleAlignment __attribute__((annotate("ui_appearance_selector")));
		//[Export("subtitleAlignment", ArgumentSemantic.Assign)]
		//NSTextAlignment SubtitleAlignment { get; set; }
	...
	partial interface Constants
	{
        ...
        IntPtr RMessageVersionString { get; }
	}
